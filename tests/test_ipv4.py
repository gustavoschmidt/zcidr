...
def test_parse_basic():
    assert z.parse_ipv4("1.2.3.4") == 0x01020304
    assert z.parse_ipv4("0.0.0.0") == 0
    assert z.parse_ipv4("255.255.255.255") == 0xFFFFFFFF
    assert z.parse_ipv4("192.168.0.1") == int(ipaddress.IPv4Address("192.168.0.1"))


def test_format_roundtrip():
    for s in ["0.0.0.0", "8.8.8.8", "192.168.1.1", "255.255.255.255", "10.0.0.1"]:
        assert z.format_ipv4(z.parse_ipv4(s)) == s
